...
- 🔄 **Mise à jour intégrée** : vérifie et installe les nouvelles versions depuis la page d'accueil, sans réinstaller manuellement
...
- 🔜 **Recherche sémantique CLIP** : prévue pour v0.7+ (gain de 2 GB sur le bundle actuel — désactivée pour rester téléchargeable rapidement)
